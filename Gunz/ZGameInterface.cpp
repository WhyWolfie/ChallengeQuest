...
//#if defined(_DEBUG)	|| defined(_RELEASE)
		...
		pServerList->AddServer("Local Host Test", "98.157.153.126", 6000, 1, 1, 500, true);
		pServerList->AddServer("Remote Host Test", "67.23.190.89", 6000, 1, 1, 500, true);
...
//		pServerList->AddServer( "", "", 0, 0, 0, 1000, false);						// Null
		...
		{
			pServerList->AddServer( (char*)ZMsg(MSG_SERVER_DEBUG), "", 0, 7, 0, 1000, true);			// Debug server
			pServerList->AddServer("Test", "98.157.153.126", 6000, 1, 1, 500, true);
//			pServerList->AddServer( "", "", 0, 0, 0, 1000, false);						// Null
		}
#endif
