...
ZActorAnimation2::ANIMATION_INFO ZActorAnimation2::m_AnimationTable[ZA_ANIM_END] = 
{
...
ZActorAnimation2::ZActorAnimation2() : m_nCurrState(ZA_ANIM_NONE), m_pBody(NULL)
{

}

ZActorAnimation2::~ZActorAnimation2()
{

}

void ZActorAnimation2::InitAnimationStates()
{
	ZState* pState;
...
void ZActorAnimation2::Init(ZActor2* pBody)
{
	m_pBody = pBody;	
...
void ZActorAnimation2::Set(ZA_ANIM_STATE nAnim, bool bReset)
{
	if ((!bReset) && (GetCurrState() == nAnim)) return;

	ZBrain2* pBrain = m_pBody->GetBrain();
...
bool ZActorAnimation2::Input(ZA_ANIM_INPUT nInput)
{
...
void ZActorAnimation2::ForceAniState(int nAnimState)
{
...
bool ZActorAnimation2::IsAttackAnimation(ZA_ANIM_STATE nAnimState)
{
	if ((nAnimState == ZA_ANIM_ATTACK_MELEE) || (nAnimState == ZA_ANIM_ATTACK_RANGE)) return true;
	return false;
}

bool ZActorAnimation2::IsSkippableDamagedAnimation(ZA_ANIM_STATE nAnimState)
{
