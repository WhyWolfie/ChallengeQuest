...
ZTask_Skill2::ZTask_Skill2(ZActor2* pParent,int nSkill,MUID& uidTarget,rvector& targetPosition) : ZTaskBase_Attack2(pParent),
					m_nSkill(nSkill), m_uidTarget(uidTarget), m_TargetPosition(targetPosition), m_pSkillDesc(NULL)
{
}

ZTask_Skill2::~ZTask_Skill2()
{

}


void ZTask_Skill2::OnStart()
{
...
ZTaskResult ZTask_Skill2::OnRun(float fDelta)
{
