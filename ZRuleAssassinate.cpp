...
void ZRuleAssassinate::AssignCommander(const MUID& uidRedCommander, const MUID& uidBlueCommander)
{
	...
	ZCharacter* pRedChar = (ZCharacter*) ZGetGame()->m_CharacterManager.Find(uidRedCommander);
	ZCharacter* pBlueChar = (ZCharacter*) ZGetGame()->m_CharacterManager.Find(uidBlueCommander);
